...
the `PuzzleDescription` module. The `PuzzleDescription` module is
defined in `puzzledescription.ml` and is opened here for
convenience. As examples of puzzle descriptions, we provide `mazes.pl`
and `tiles.pl`.
 *)
